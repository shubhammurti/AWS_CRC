        ...
        <div className="">
          ...
          <div className="mt-8 flex md:flex-row justify-between flex-col md:items-stretch items-center ">
            {serviceData.map((el) => (
              ...
              >
                <img src={el.img} alt="" />
                <h2 className="text-3xl font-bold mt-4">{el.name}</h2>
                <h3 className="text-xl font-bold mt-4">{el.schoolname}</h3>
                <h3 className="text-xl font-medium mt-4">{el.boardname}</h3>
                <p className="text-lg mt-2 font-normal text-justify">{el.desc}</p>
              </motion.div>
            ))}
          </div>
        </div>
